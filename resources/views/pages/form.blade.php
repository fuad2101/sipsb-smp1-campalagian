...
<div>
    ...
    <form action="/form" method="post" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col">
                <label class="form-label" for="">Upload Foto</label><input class="form-control form-control-sm @error('foto') is-invalid @enderror"" type="file" name="foto" id="" accept=".jpg,.jpeg" required>
                @error('foto')
                <div class="invalid-feedback">
                    {{$message}}
                </div>
